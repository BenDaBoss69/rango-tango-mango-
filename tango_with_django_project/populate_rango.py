...
def populate():
    ...
    add_page(python_cat, 'Official Python Tutorial', 'http://docs.python.org/3/tutorial/', views=50)
    ...
    add_page(django_cat, 'Official Django Tutorial', 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', views=40)
